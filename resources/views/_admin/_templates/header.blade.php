        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="robust admin logo" src="{{ URL::asset('admin/images/logo/logo-light-sm.png') }}">
              <h3 class="brand-text">BMS Event</h3>
            </a>
          </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="avatar avatar-online">
                  <img src="{{ URL::asset('admin/images/portrait/small/avatar-s-1.png') }}"
                  alt="avatar"><i></i></span>
