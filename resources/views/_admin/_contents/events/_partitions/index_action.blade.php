...
<div class="dropdown-menu" x-placement="bottom-start">
	<a onclick="_nametags(this)" class="dropdown-item">Generate Name Tag</a>    
	<div class="dropdown-divider"></div>
    <a onclick="_edit(this)" class="dropdown-item">Edit</a>    
    <a data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#detail-event" class="dropdown-item">Detail</a>
    <div class="dropdown-divider"></div>
